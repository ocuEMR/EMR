...
public class TestController implements Serializable {
    ...
    @EJB
    private Bean.TestFacade ejbFacade;
    ...
    public static void setCurrentTest(Test currentTest) {
        TestController.currentTest = currentTest;
    }
    ...
    public String prepareCreateForVisit() {
        ...
        selectedItemIndex = -1;
        currentTest = null;
        return "/JSF/test/Create?faces-redirect=true";
    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TestUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TestDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
