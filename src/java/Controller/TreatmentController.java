...
public class TreatmentController implements Serializable {
    ...
    public static Treatment currentTreatment;

    public static Treatment getCurrentTreatment() {
        return currentTreatment;
    }

    public static void setCurrentTreatment(Treatment currentTreatment) {
        TreatmentController.currentTreatment = currentTreatment;
    }
    ...
    public String create() {
        try {
            current.setMedical(MedicalTreatmentController.currentMedicalTreatment); 
    ...
    public static class TreatmentControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Treatment) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + TreatmentController.class.getName());
            }
        }
    }
}
